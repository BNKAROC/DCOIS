import struct
import datetime
import flash_load_1V0 as flash_load
import AW86008
import time
from smbus3 import SMBus, i2c_msg
import FIT_1v1 as FIT
#v0.0 old checksum method
#V1.0 first version
#V1.1 added weight for <100mm focal length
...
dataload=flash_load.generate_dataload(0x01, 0x03, coefficients)
print("数据加载:", dataload)
